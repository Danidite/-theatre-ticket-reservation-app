...
public class Register {
	 ...
	 */
	public Register(Movie movie, Theatre theatre, double price, int seatRow, int seatColumn, boolean earlyBooking, int showYear, int showMonth, int showDay, int showHour, int announcementYear, int announcementMonth, int announcementDay) {
...
//		System.out.println(today);
	 ...
	 * @param registerID
	 */
	Register(Movie movie, Theatre theatre, double price, int seatRow, int seatColumn, boolean earlyBooking, int showYear, int showMonth, int showDay, int showHour, int announcementYear, int announcementMonth, int announcementDay, String registerID) {
		this.setMovie(movie);
